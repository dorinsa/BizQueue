    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.muted}>Create your business to start managing appointments.</Text>

          <Pressable
            style={styles.primaryButton}
            onPress={() => router.push({ pathname: "/create-business" })}
          >
...
const styles = StyleSheet.create({
  ...
  value: { fontSize: 20, fontWeight: "800", marginBottom: 6 },
  muted: { color: "#666" },
  ...
  logoutHeaderText: { color: "#FF5B5B", fontWeight: "bold" },
});
